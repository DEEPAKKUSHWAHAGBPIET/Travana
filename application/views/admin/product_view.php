            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title">View All Products
                     <small class="category badge badge-danger float-right"><a href="<?php echo base_url()."delete_img"; ?>">Delete Images</a></small>
                  </h4>
                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">Off Per(%)</th>
                          <th class="text-center">Final Amount</th>
                          <th class="text-center">Deli. Dates</th>
                          <th class="text-center">Status</th>
                          <th class="text-center">Action</th>
                          <th class="text-center">Img I</th>
                          <th class="text-center">Img II</th>
                          <th class="text-center">Img III</th>
                          <th class="text-center">Img IV</th>
                          <th class="text-center">Dis. I</th>
                          <th class="text-center">Dis. II</th>
                          <th class="text-center">Dis. III</th>
                          <th class="text-center">Dis. IV</th>
                          <th class="text-center">Description</th>
                          <th class="text-center">Details</th>
                           <th class="text-center">Keywords</th>
                          <th class="text-center">Dis. Detail I</th>
                          <th class="text-center">Dis. Detail II</th>
                          <th class="text-center">Dis. Detail III</th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo get_value('tbl_category','cat_id',$value->cat_id,'category_name'); ?></td>
                            <td><?php echo get_value('tbl_sub_category','sub_cat_id',$value->sub_cat_id,'sub_cat_name'); ?></td>
                            <td><?php echo get_value('tbl_brand','brand_id',$value->brand_id,'brand_name'); ?></td>
                            <td><?php echo $value->pro_amount; ?></td>
                            <td><?php echo $value->pro_off_percentage; ?></td>
                            <td><?php echo $value->pro_final_amount; ?></td>
                            <td><?php echo $value->pro_delivery_dates; ?></td>
                            ...
                            <a href="<?php echo base_url()?>Admin_controller/upd_status/tbl_products/product_id/<?php echo $value->product_id;?>/status/<?php echo $status_val."/".$this->uri->segment('1');?>" class="btn btn-link btn-warning btn-just-icon edit"
                            <?php if($value->status =='YES'){ echo"title='Turn Off Product'"; }else{ echo"title='Turn On Product'";} ?>><i class="material-icons">dvr</i></a>
                              <?php }else{ ?>
                                <?php if($value->status_seller =='YES'){ $status_val="NO";}else{ $status_val="YES";} ?>
                            <a href="<?php echo base_url()?>Admin_controller/upd_status/tbl_products/product_id/<?php echo $value->product_id;?>/status_seller/<?php echo $status_val;?>/product_view" class="btn btn-link btn-warning btn-just-icon edit"
                            <?php if($value->status_seller =='YES'){ echo"title='Turn Off Product'"; }else{ echo"title='Turn On Product'";} ?>><i class="material-icons">dvr</i></a>
                              <?php }?>
                              <?php if($this->session->userdata('customer_id') == $value->customer_id){ ?>
                            <a href="<?php echo base_url()?>product_edit/<?php echo $value->product_id;?>" class="btn btn-link btn-danger btn-just-icon edit" title="Edit The Products Details"><i class="material-icons">edit</i></a>
                          <?php } ?>
                          </td>
                          <td><img src="<?php echo base_url()?>uploads/<?php echo $value->pro_img1; ?>" class="card-avatar1"></td>
                          <td><img src="<?php echo base_url()?>uploads/<?php echo $value->pro_img2; ?>" class="card-avatar1"></td>
                          <td><img src="<?php echo base_url()?>uploads/<?php echo $value->pro_img3; ?>" class="card-avatar1"></td>
                          <td><img src="<?php echo base_url()?>uploads/<?php echo $value->pro_img4; ?>" class="card-avatar1"></td>
                          <td><img src="<?php echo base_url()?>uploads/<?php echo $value->des_img1; ?>" class="card-avatar1"></td>
                          <td><img src="<?php echo base_url()?>uploads/<?php echo $value->des_img2; ?>" class="card-avatar1"></td>
                          <td><img src="<?php echo base_url()?>uploads/<?php echo $value->des_img3; ?>" class="card-avatar1"></td>
                          <td><img src="<?php echo base_url()?>uploads/<?php echo $value->des_img4; ?>" class="card-avatar1"></td>
                          <td><?php echo $value->product_description; ?></td>
                            <td><?php echo $value->pro_details; ?></td>
                        <td><?php echo $value->pro_keywords; ?></td>
                        <td><?php echo $value->des_line1; ?></td>
                        <td><?php echo $value->des_line2; ?></td>
                        <td><?php echo $value->des_line3; ?></td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
