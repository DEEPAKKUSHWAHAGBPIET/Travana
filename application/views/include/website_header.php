    ...
    <header>
        <div class="container">
            ...
            <nav class="top_nav d-flex pt-3 pb-1">
                <!-- logo -->
                <h1>
                    <a class="navbar-brand" href="<?php echo base_url()."website_home";?>">
                 <img  src="uploads/oslogo.png" width="250" height="50">
                    </a>
                </h1>
                <!-- //logo -->
                ...
                <div class="w3ls_right_nav ml-auto d-flex">
                  ...
                  <input  type="text" name="search_keywords" placeholder="Search Product" class="form-control search_boxown" required="true" id="search_input" autocomplete="off">
                        </div>
                      <select  class="form-control input-lg search_list" name="search_options">
                        ...
                        <input  class="btn btn-outline-secondary btn-info ml-3 my-sm-0" type="submit" value="Search">
                    </form>
                    <!-- search form -->
                    <div class="nav-icon d-flex">
                        ...
                        <a class="text-dark login_btn align-self-center mx-3" href="<?php echo base_url().$profile_link1;?>">
                            <i class="far fa-user fa-thin" style="color: #76289a; "></i>
                        </a>
                        <!-- sigin and sign up -->
                        <!-- shopping cart -->
                        <div class="cart-mainf">
                            <a class="btn top_hub_cart mt-1"  title="Cart" href="<?php echo base_url()."customer_cart";?>">
                                        <i class="fas fa-shopping-bag" style="color: #76289a;"></i>
                            </a>
                          </div>
            ...
            <!-- //top nav -->
            <style type="text/css">
                .search_boxown{margin-right: 40px!important;background: #fff!important;width: 150px!important;}
