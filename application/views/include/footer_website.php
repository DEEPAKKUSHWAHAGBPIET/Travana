        ...
        <div class="footerv2-w3ls">
            <div class="footer-w3lagile-innerr">
                ...
                <div class="container-fluid">
                    <div class="row  footer-v2grids w3-agileits">
                        ...
                        <!-- //services -->
                        <!-- latest posts -->
                       <!-- <div class="col-lg-4 col-sm-6 footer-v2grid mt-sm-0 mt-5">
                           <h4>Latest Blog</h4>
                            <?php
                     ...
                     <!--   <div class="col-lg-2 col-sm-6 footer-v2grid my-lg-0 my-5">
                        ...
                        <!-- //flickr posts -->
                       <!-- popular tags -->
                        <div class="col-lg-4  footer-v2grid mt-sm-0 mt-5">
                            <h4>popular tags</h4>
                            <ul class="w3-tag2">
                            <?php
                ...
                <div class="footer-bottomv2 py-5">
                    <div class="container">
                        <ul class="bottom-links-agile">
                            <li>
                                <a style="color:purple;" href="<?php echo base_url()?>website_home">Home</a>
                            </li>
                            <li>
                                <a style="color:purple;" href="<?php echo base_url()?>contact">Contact</a>
                            </li>
            ...
            <div class="container-fluid py-5 footer-copy_w3ls">
                <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="cpy-right align-self-center" style="padding-left :480px;">
                        <h2 class="agile_btxt">
                            <a href="index.html">
                              <!--  <span>O</span>nline
                                <span>S</"span>hopping</a>-->
                                <span><img src="uploads/oslogo.png" width="250" height="60"></span>
                        </h2>
                        <p>© <?php echo date('Y');?> Travel Website | Designed by DSA.
                        </p>
                    </div>
                </div>
            </div>
