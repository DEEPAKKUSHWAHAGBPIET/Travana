                ...
                <div class="card-body ">
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="email" class="form-control" placeholder="Email..." name="email_id" required="true" value="">
                    </div>
                  </span>
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="password" class="form-control" placeholder="Password..." name="password" required="true" value="user@1234">
                    </div>
                  </span>
                </div>
                <div class="card-footer justify-content-center">
                  <input type="submit" name="login_validate" value="Lets Go" class="btn btn-primary">
                </div>
              </div>
            </form>
          </div>
