...
<body class="off-canvas-sidebar">
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('<?php echo base_url()?>assets/admin_assets/img/login_22222.jpg'); background-size: cover; background-position: top center;">
              ...
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  ...
                  <div class="form-group">
                          <label class="btn btn-round btn-primary btn-file" for="photo">Photo<div class="ripple-container"></div></label>
                           <input type="file" name="photo" class="btn btn-round btn-rose btn-file" id="photo">
                           <center><img class="img blah" src="<?php echo base_url()?>assets/admin_assets/img/faces/avatar.png"></center>
                        </div>
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="First Name..." name="user_name" required="true" value="">
                    </div>
                  </span>
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="email" class="form-control" placeholder="Email..." name="email_id" id="email_id" value="" required="true" value="" onkeyup="check_mail()">
                    </div>
                  </span>
                  <span class="bmd-form-group">
                    <div class="input-group">
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="tel" class="form-control" placeholder="Mobile Number" name="mobile_no" required="true" value="" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" minlength="10" maxlength="10">
                      
                    </div>
                  </span>
                </div>
                <div class="card-footer justify-content-center">
                  <input type="submit" name="login_validate" value="Register" class="btn btn-primary">
                </div>
              </div>
            </form>
          </div>
...
<script>
  ...
  <script type="text/javascript">
      function check_mail(){
        ...
        var $url="<?php echo base_url();?>check_mail";
        // alert($url);
        $.ajax({ 
          url: $url,
          type:"POST",
...
<style type="text/css">
  .blah{width: 150px;height: 150px;border-radius: 15px;}
</style>