...
<!---728x90--->
            ...
            <ul class="rslides" id="slider3">
                ...
                <li class="banner">
                    ...
                    <div class="container">
                        ...
                        <h4 class="w3_bbot">SHOP | TRAVEL | LIVE</h4>
    ...
    <div class="agileits-services" id="services">
        <div class="no-gutters agileits-services-row row">
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                <span class="fas fa-sync-alt p-4" style="color: purple;"></span>
                <h4 class="mt-2 mb-3">30 days replacement</h4>
            </div>
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                <span class="fas fa-gift p-4" style="color: purple;"></span>
                <h4 class="mt-2 mb-3">Gift Card</h4>
            </div>

            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                <span class="fas fa-lock p-4" style="color: purple;"></span>
                <h4 class="mt-2 mb-3">secure payments</h4>
            </div>
            <div class="col-lg-3 col-sm-6 agileits-services-grids p-sm-5 p-3">
                <span class="fas fa-shipping-fast p-4" style="color: purple;"></span>
    ...
    <section class="tabs_pro py-md-5 pt-sm-3 pb-5">
        <h5 class="head_agileinfo text-center text-capitalize pb-5">
            <span style="color: purple;">B</span>est <span style="color: purple;">S</span>eller</h5>
        <div style="color: purple;" class="tabs tabs-style-line pt-md-5">
            <nav class="container">
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    ...
                                    <input type="hidden" name="" class="already_inwishlist" value="<?php echo $wishlist_a;?>">
                                        ...
                                        <button type="submit" class="hub-cart phub-cart btn add_to_cart">
                                            <i style="color: purple;" class="fa fa-cart-plus  <?php echo $cart_clr;?>" aria-hidden="true"></i>
                                        </button>
                                        <?php } ?>
                                        <button type="submit" class="hub-cart phub-cart btn add_to_wishlist ml-5">
                                            <i style="color: purple;" class="fa fa-heart <?php echo $wishlist_clr;?>" aria-hidden="true"></i>
                                        </button>
                                </div>
                            </div>
                            <!-- //card -->
