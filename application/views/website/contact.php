...
<?php $this->load->view('include/website_header'); ?>
	...
	<div class="ibanner_w3 pt-sm-5 pt-3">
		<h4 class="head_agileinfo text-center text-capitalize text-center pt-5">
			<span style="color:purple;">T</span>ravana
			</h4>
	</div>
	<!-- //inner banner -->
    <!-- breadcrumbs -->
    ...
    <section class="wthree-row pt-3 pb-sm-5 w3-contact">
        <div class="container py-sm-5 pb-5">
            <h5 class="head_agileinfo text-center text-capitalize pb-5">
                <span style="color:purple;">C</span>ontact us</h5>
            <div class="row contact-form pt-lg-5">
                <div class="col-lg-6 wthree-form-left">
                    <!-- contact form grid -->
                    <div class="contact-top1">
                        <h5 class="text-dark mb-4 text-capitalize">send us a feedback</h5>
                        ...
                        <form action="<?php echo base_url()?>send_feedback" method="post" class="f-color">
                            <div class="form-group">
                                <label for="contactusername">Name</label>
                                <input type="text" class="form-control" id="contactusername" required name="sender_name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="5" id="contactcomment" required name="sender_comment"></textarea>
                            </div>
                ...
                <div class="col-lg-6 contact-bottom pl-5 mt-lg-0 mt-5">
                    ...
                    <div class="address">
                        ...
                        <address>
                            <p class="c-txt"><?php echo $admin_data[0]->address; ?></p>
                            <p class="c-txt"><?php echo $admin_data[0]->city." - ".$admin_data[0]->pincode." - ".$admin_data[0]->country; ?></p>
                        </address>
                    </div>
                    ...
                    <div class="address my-5">
                        ...
                        <p>
                            <?php echo $admin_data[0]->mobile_no; ?></p>
                    </div>
                    <!-- contact details grid3 -->
                    <div class="address mt-md-0 mt-3">
                        <h5 class="pb-3 text-capitalize">Email</h5>
                        <p>
                            <a href="mailto:info@example.com"><?php echo $admin_data[0]->email_id; ?></a>
                        </p>
                    </div>
        ...
        <div class="map contact-right pb-5">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d62456.799121281474!2d79.7785083213391!3d11.936377111166756!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1624621574296!5m2!1sen!2sin" allowfullscreen></iframe>
        </div>
