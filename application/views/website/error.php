...
<!---728x90--->
	...
	<div class="ibanner_w3 pt-sm-5 pt-3">
		<h4 class="head_agileinfo text-capitalize text-center pt-5 own_clr pl-5">
			<!-- <span>E</span>rror -->
		</h4>
	...
	<nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Page not Found Try again</li>
       
        </ol>
    </nav>
    <div class="row">
    	<div class="col-md-3">
    		<img src="<?php echo base_url()."assets/website_assets/images/cry.gif";?>" class="img_cry">
    	</div>
    	<div class="col-md-8">
    		<h4 class="head_agileinfo text-capitalize text-left pt-5 own_clr pl-5">
			<span><?php echo $var; ?></span></h4>
    	</div>
		</div>
...
.clr_red{
    ...
    .ibanner_w3 {
    background: url(<?php echo base_url()."assets/website_assets/images/error.png";?>)no-repeat center;
