...
<!---728x90--->
	...
	<div class="ibanner_w3 pt-sm-5 pt-3">
		<h4 class="head_agileinfo text-capitalize text-left pt-5 own_clr pl-5">
			<span>Y</span>our
			<span>s</span>earch
			<span>i</span>tem
		</h4>
	...
	<nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?php echo"Your Looking for - '<span class='text-success'>".$search_keyword."'</span >"; ?></li>
        <?php } ?>
        </ol>
    </nav>
	<!-- //breadcrumbs -->
						...
						<h3 class="shopf-sear-headits-sear-head">Categories</h3>
							<ul>
								<?php foreach ($category as $key => $value) { ?>
									<li class="own_cat"><a href="<?php echo base_url()."cat_v/".$value->cat_id; ?>"><?php echo $value->category_name; ?></a></li>
								<?php } ?>
...
<?php if(!empty($product_data)){ ?>
    .ibanner_w3 {
    background: url(<?php echo base_url()."assets/website_assets/images/search.jpg";?>)no-repeat center;
...
.own_clr{color: #0b80f9 !important;}
</style>
<script type="text/javascript">
    (function() {
        ...
        function rangeInputChangeEventHandler(e){
        	var money_type = "<?php echo get_value('tbl_login','customer_id',1,'money_type'); ?>";
